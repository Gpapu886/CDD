...
Our dataset employs dual annotation methodologies to ensure comprehensive characterization of dental conditions. For object localization, we utilize horizontal bounding boxes (xmin, ymin, xmax, ymax) in coco format (.xml files) to delineate caries and non-caries regions in dental images. Complementing this spatial annotation, we incorporate the International Caries Detection and Assessment System (ICDAS) criteria to provide standardized clinical classifications, including detailed severity grading of carious lesions. This hybrid annotation approach enables both precise lesion localization and clinically-relevant diagnostic characterization.
